...
class BDD {
    ...
    function conectar() {
        ...
        if($this->mysqli->connect_errno){
            throw new Exception("No se pudo establecer la conexión con la base de datos ".$this->bdd_name." en ".$this->host." con el usuario ".$this->user_name.". Error: ".$this->bdd_name.$this->mysqli->connect_error);
        }
