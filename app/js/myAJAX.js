...
function notificar(mensaje) {
    $("body").append("<div class='alert alert-success notificacion alert-fixed-bottom'>" + mensaje + "</div>");
    createAutoClosingAlert(".notificacion", 2000);
}

function notificar_error(mensaje) {
    $("body").append("<div class='alert alert-danger alert-dismissable notificacion-error alert-fixed-bottom'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><strong>Error:</strong> " + mensaje + "</div>");
    //createAutoClosingAlert(".notificacion", 2000);
}
