    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a title="Notificaciones" href="<?php echo direcciones::index ?>"><span class="glyphicon glyphicon-bell"></span></a></li>
                <!--<li><a href="<?php echo direcciones::objetivos ?>">Objetivos</a></li>-->
                <li><a title="Grupos" href="<?php echo direcciones::grupos ?>"><span class="glyphicon glyphicon-record"></span></a></li>
                <!--
                <li class="dropdown">
                ...
                <li><a title="Salir" href="<?php echo direcciones::logout ?>"><span class="glyphicon glyphicon-log-out"></span></a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</div>
